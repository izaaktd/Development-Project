...
class App():
    ...
    def create_app(self):
        ...
        # Pass the path to the photo in your local computer here.
            ...
            frame.pack()
            tkr.Label(frame, text="Domestic Hour", bg='blue', fg='white', font='times 20 bold').grid(row=0, column=0, sticky=W)
            tkr.Label(frame, text="International Hour", bg='blue', fg='white', font='times 20 bold').grid(row=1, column=0, pady=10,sticky=W)                                                                                    
            tkr.Label(frame, text="Total Hours", bg='blue', fg='white', font='times 20 bold').grid(row=2, column=0, pady=10,sticky=W)                                                                                       
            tkr.Label(frame, text="Domestic Pay", bg='blue', fg='white', font='times 20 bold').grid(row=3, column=0, pady=10,sticky=W)
            tkr.Label(frame, text="International Pay", bg='blue', fg='white', font='times 20 bold').grid(row=4, column=0, pady=10,sticky=W)
            tkr.Label(frame, text="Total Pay", bg='blue', fg='white', font='times 20 bold').grid(row=5, column=0, pady=10,sticky=W)


            tkr.Entry(frame, width=34, bg="white", textvariable=month).grid (row=0, column=1)
            tkr.Entry(frame, width=34, bg="white", textvariable=month).grid (row=1, column=1)
            tkr.Entry(frame, width=34, bg="white", textvariable=month).grid (row=2, column=1)
            tkr.Entry(frame, width=34, bg="white", textvariable=month).grid (row=3, column=1)
            tkr.Entry(frame, width=34, bg="white", textvariable=month).grid (row=4, column=1)
            tkr.Entry(frame, width=34, bg="white", textvariable=month).grid (row=5, column=1) 
